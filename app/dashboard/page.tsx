    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Badge
            variant="outline"
            className={user?.role === "super_admin" ? "bg-primary/10 text-primary" : "bg-blue-500/10 text-blue-500"}
          >
            {user?.role === "super_admin" ? "Super Admin" : user?.name || "Admin"}
          </Badge>
      ...
      {/* Main Content Tabs - Show only tabs the user has permission for */}
      <Tabs defaultValue="overview" className="w-full">
        ...
        >
          ...
          {canAccess("users") && <TabsTrigger value="users">User Management</TabsTrigger>}
          {canAccess("logs") && <TabsTrigger value="system">System Status</TabsTrigger>}
          {canAccess("logs") && <TabsTrigger value="logs">System Logs</TabsTrigger>}
        </TabsList>
